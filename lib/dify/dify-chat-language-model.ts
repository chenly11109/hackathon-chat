...
import { mapDifyFinishReason } from './map-dify-finish-reason';
import {
    DifyChatModelId,
    DifyChatSettings,
...
export class DifyChatLanguageModel implements LanguageModelV1 {
    ...
    async doGenerate(
        ...
        return {
            ...
            finishReason: mapDifyFinishReason(choice.finish_reason),
            usage: {
                    ...
                    transform(chunk, controller) {
                        ...
                        if (delta.tool_calls != null) {
                            for (const toolCall of delta.tool_calls) {
                                // dify tool calls come in one piece
...
const difyChatResponseSchema = z.object({
    choices: z.array(
        z.object({
            message: z.object({
...
// limited version of the schema, focussed on what is needed for the implementation
// this approach limits breakages when the API changes and increases efficiency
const difyChatChunkSchema = z.object({
